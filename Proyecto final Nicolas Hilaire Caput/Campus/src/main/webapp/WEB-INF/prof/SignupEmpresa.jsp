...
<div class="col s12 m4 l4 " style="background-color: #cfd8dc;"> <br>
<a href="ServletNoSignupProfe" class='deep-orange lighten-1 btn-small right'>Profesor</a>
    <h1 class="center-align">Registro Empresa</h1>
