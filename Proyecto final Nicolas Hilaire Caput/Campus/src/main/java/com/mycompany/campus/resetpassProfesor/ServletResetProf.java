 ...
 * @author WEB 2
 */
@WebServlet(name = "ServletResetProf", urlPatterns = {"/ServletResetProf"})
public class ServletResetProf extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (pass != null) {
            ...
            request.setAttribute("pagina", "prof/NewPass");
