 ...
 * @author WEB 2
 */
@WebServlet(name = "NoServletContent", urlPatterns = {"/NoServletContent"})
public class NoServletContent extends HttpServlet {
