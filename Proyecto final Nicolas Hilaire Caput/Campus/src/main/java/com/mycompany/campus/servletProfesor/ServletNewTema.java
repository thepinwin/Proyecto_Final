 ...
 * @author WEB 2
 */
@WebServlet(name = "ServletNewTema", urlPatterns = {"/ServletNewTema"})
public class ServletNewTema extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        crud.newTema(Integer.parseInt(cursoId), titulo, new BigDecimal(precio));
