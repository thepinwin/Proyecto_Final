 ...
 * @author WEB 2
 */
@WebServlet(name = "NewNoCurso", urlPatterns = {"/NewNoCurso"})
public class NewNoCurso extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("catess", crud.categoria());
        
        RequestDispatcher rs = request.getRequestDispatcher("/WEB-INF/Layout.jsp");
        
        request.setAttribute("pagina", "NewCurso");
