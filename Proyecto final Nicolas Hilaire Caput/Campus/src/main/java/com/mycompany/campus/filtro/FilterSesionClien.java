 ...
 */
package com.mycompany.campus.filtro;
...
* @author luis
*/
public class FilterSesionClien implements Filter {
...
public FilterSesionClien() {
}

private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
throws IOException, ServletException {
if (debug) {
log("FilterSesion:DoBeforeProcessing");
}
...
throws IOException, ServletException {
if (debug) {
log("FilterSesion:DoAfterProcessing");
}
...
if (session.getSession().getAttribute("logClien")== null){
...
if (debug) {
log("FilterSesion: Initializing filter");
}
}
}
...
StringBuffer sb = new StringBuffer("FilterSesion(");
...
if (debug) {
System.out.println("FilterSesion::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
}
...
if (debug) {
System.out.println("FilterSesion::getParameter(" + name + ") localParams = " + localParams);
}
if (localParams == null) {
...
if (debug) {
System.out.println("FilterSesion::getParameterValues(" + name + ") localParams = " + localParams);
}
if (localParams == null) {
...
if (debug) {
System.out.println("FilterSesion::getParameterNames() localParams = " + localParams);
}
if (localParams == null) {
...
if (debug) {
System.out.println("FilterSesion::getParameterMap() localParams = " + localParams);
}
if (localParams == null) {
