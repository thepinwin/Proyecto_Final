 ...
 * @author thepinguin
 */
@WebServlet(name = "Informar", urlPatterns = {"/Informar"})
public class Informar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String txt = "Numero de pedido "+factura+
                ".\n Curso comprado \n."
                + "Tranferencia a la cuenta 584654646464464.\n"
                + "Saludos equipo de Campus Online";

        ResetPass.Enviar(cli.getMail(), "Compra en Campus Online:", txt);
