 ...
 * @author WEB 2
 */
@WebServlet(name = "ServletResetPass", urlPatterns = {"/ServletResetPass"})
        ...
        if (id != null) {
            ...
            if (cli != null) {
                String txt = "Hola, " + cli.getNombre()
                        ...
                        + "<a href='http://localhost:8080/Campus/ServletReset?id=" + link + "'>Camiar contraseña</a>";
