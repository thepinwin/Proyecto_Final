...
public class ServletPrincipal extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        CrudProfesor curd = new CrudProfesor();
        HttpSession session = request.getSession();

        request.setAttribute("ProfCur",
                curd.allCursProf(((Profesor) session.getAttribute("logProf")).getId())
        );
        
        RequestDispatcher rs = request.getRequestDispatcher("/WEB-INF/Layout.jsp");

        request.setAttribute("pagina", "IndexProfe");
